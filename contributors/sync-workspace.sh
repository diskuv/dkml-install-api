...
opam pin dkml-component-xx-console            git+file://"$SOURCEMIXED"/dkml-component-console#main --no-action --yes
...
opam pin -k version dune                  2.9.3+shim.1.0.1 --no-action --yes
