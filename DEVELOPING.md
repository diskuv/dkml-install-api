...
Z:\source\dkml-install-api\_opam\bin\dkml-package-setup.bc
Z:\source\dkml-install-api\_opam\bin\dkml-package-uninstaller.bc

with-dkml env OCAMLRUNPARAM=b Z:\source\dkml-install-api\_opam\bin\dkml-package-setup.bc --name test123 --prefix Z:\temp\prefix --opam-context --component network-ocamlcompiler -v
with-dkml env OCAMLRUNPARAM=b Z:\source\dkml-install-api\_opam\bin\dkml-package-uninstaller.bc --name test123 --prefix Z:\temp\prefix --opam-context --component network-ocamlcompiler -v
...
```
dkml-package-setup.bc: [ERROR] Dynlink.Error (Dynlink.Cannot_open_dll "Dynlink.Error (Dynlink.Cannot_open_dll \"(Failure \\\"Cannot reso        olve camlDkml_install_api__log_spawn_and_raise_417\\\")\")")
